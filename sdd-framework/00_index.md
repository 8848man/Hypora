...
**What this is:** A generalized, project-agnostic extraction of the Specification-Driven Development (SDD) methodology observed in the Sentinel project (`sentinel_mvp`), which serves here as its **first reference implementation** — not this framework's permanent source of truth (see `01_philosophy.md`, Principle 8). This documentation set is written so a new, unrelated project can recreate the same methodology from these documents alone — without ever seeing Sentinel's actual specs.
