...
| [07](./07_onboarding_preset_assistant.md) | Onboarding Preset Assistant | Introduced alongside [ADR-0019](../../architecture/decisions/ADR-0019-ai-generated-onboarding-presets-at-project-creation.md), 2026-07-20; Response Contract simplified to always-concrete presets by [ADR-0021](../../architecture/decisions/ADR-0021-always-concrete-onboarding-presets.md), 2026-07-21 (not a V-numbered roadmap stage — see [Future Expansion Strategy](../../context/06_future_expansion_strategy.md#future-ready-architecture-principle)) | Generate tailored, concrete starting presets for all five Canvas questions from a Project's Name/Description at creation; the AI Platform's second, narrowly-scoped Automatic Invocation, per ADR-0019 |
