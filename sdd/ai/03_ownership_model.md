...
| [Project Summary Synthesis Assistant](./capabilities/06_project_summary_synthesis_assistant.md) | Canvas only (per [ADR-0018](../architecture/decisions/ADR-0018-narrow-project-summary-to-business-canvas-identity-synthesis.md); Contract Version 1.0 additionally read MVP Scope and Validation Checklist — see that capability's Contract Version History) | Project Summary (identity narrative; `initial_generation` writes directly, `sync` writes only via the user's own Apply — see [ADR-0016](../architecture/decisions/ADR-0016-project-summary-persisted-ai-synthesized-lifecycle.md)/[ADR-0017](../architecture/decisions/ADR-0017-automatic-invocation-for-project-summary-initial-generation.md)/[ADR-0018](../architecture/decisions/ADR-0018-narrow-project-summary-to-business-canvas-identity-synthesis.md)) |
| [Onboarding Preset Assistant](./capabilities/07_onboarding_preset_assistant.md) | Project name, Project description (optional) — no Canvas context exists yet at invocation time | Nothing persisted directly — produces preset/Thinking Prompt content handed to Business Structuring's guided flow; no Canvas field is ever written by this capability (see [ADR-0019](../architecture/decisions/ADR-0019-ai-generated-onboarding-presets-at-project-creation.md)) |
